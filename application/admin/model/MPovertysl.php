...
{   
  //==============================================================
    //数据库查询所有数据集
      ...
      {
       $users = Db::table('povertysl')->where([$usertype=>array('neq','')])->paginate(15);
       return $users;
      }
      ...
      public function checkall($yuanxi,$banbie,$xuejihao,$zhuanye)
      {
       ...
       $users = Db::table('povertysl')->where(["yuanxi"=> $yuanxi , "banbie"=> $banbie , "xuejihao"=> $xuejihao ,"zhuanye"=> $zhuanye]) ->paginate(15,false,
      ...
      public function deleteall($yuanxi,$banbie,$xuejihao,$zhuanye)
      {
        ...
        if($xuejihao == "notype"){$xuejihao = array('neq','');}
        if($zhuanye == "notype"){$zhuanye = array('neq','');}
       Db::table('povertysl')->where(["yuanxi"=> $yuanxi , "banbie"=> $banbie , "xuejihao"=> $xuejihao ,"zhuanye"=> $zhuanye]) ->delete();
      }
...
//================================================================
        ...
        {
          $stu = Db::table('povertysl')->where('stuid',$stuid)->find(); // 获取数据集
          return $stu;
        }
        ...
        {
          Db::table('povertysl')->where('stuid',$stuid)->delete();
        }
 ...
 //===================================================================       
        ...
        {
          Db::table('povertysl') ->where('stuid',$stuid) ->update([$type => $name]);
        }
 }
 ?>